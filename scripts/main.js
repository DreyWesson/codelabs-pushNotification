...
const applicationServerPublicKey =
  "BLD30QxkXH7a0tV7C5UX2MKi19zSsEo5jOAFCnRkT2k5fp5QykdzNKVPRYYMxw-JtzPe5iaBrO3s483N6PD0Ghg";
...
function subscribeUser() {
  ...
  swRegistration.pushManager
    ...
    .then(function (subscription) {
      ...
      // In a real application, the function updateSubscriptionOnServer() is where you would send your subscription data to a backend
